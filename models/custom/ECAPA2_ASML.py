...
class Local_FE_Block(nn.Module):
    def __init__(self, inplanes, planes, frequncy, kernel_size=(3, 3), stride=(1, 1), bottleneck=128):
        ...
        self.conv2  = nn.Conv2d(inplanes, inplanes, kernel_size=kernel_size, padding=num_pad)
...
class ECAPA_TDNN(nn.Module):
    def __init__(self, C = 512, hidden=96, bottleneck = 128, nOut = 192, n_mels = 80, log_input = False, **kwargs):
