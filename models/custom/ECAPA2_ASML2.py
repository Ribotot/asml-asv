...
class ECAPA_TDNN(nn.Module):
    def __init__(self, C = 512, hidden=102, bottleneck = 128, nOut = 192, n_mels = 80, log_input = False, **kwargs):
        ...
        self.block1D_1 = nn.Sequential(
            Local_FE_Block(1, hidden, n_mels, kernel_size=(3, 3), stride=(1, 1), bottleneck=bottleneck),
            )
        ...
        self.block1D_4 = nn.Sequential(
            ...
            Local_FE_Block(hidden, hidden, n_mels//4, kernel_size=(3, 3),  stride=(1, 1), bottleneck=bottleneck),
            Local_FE_Block(hidden, hidden, n_mels//8, kernel_size=(3, 3),  stride=(2, 2), bottleneck=bottleneck),
            )
        ...
        self.block2D = Global_FE(hidden*n_mels//8, C, 1536, bottleneck=bottleneck)
